...
pred = np.load('./generated_data/pred_graph.npy')
pred_file = open("./generated_data/pred_graph.vtk", "w")
...
test_sample = np.load('./generated_data/test_sample_graph.npy')
test_sample_file = open("./generated_data/test_sample_graph.vtk", "w")
